...
<title>Saudi Arabia F1 race</title>
...
<img src="<%=request.getContextPath()%>/images/ab_mm.png"></img>
<div class="title-details">
<div class="flag">
</div>
<div class="text">
<div class="headline"><span style="color:red;">SAUDI ARABIA CIRCUT</span> <span>
<span style='color:white;'>17 - 19 MARCH</span>
</span></div>
<div class="d1" style="color:white;">FORMULA 1 SAUDI ARABIA GRAND PRIX 2023</div>
</div>
</div>
</div>
</div>
...
<a href="<%=request.getContextPath()%>/saudi_arabia.jsp?track=Saudi Arabia&id_user=<% beans.Korisnik ts=(beans.Korisnik)request.getAttribute("pearson"); if(ts!=null){out.println(ts.getId());} %>"  class="tab">Tickets</a>
  ...
  <table border="none" cellpadding="5">
    		...
    		<c:if test="${element.super_user == 0}">
                  <td>Ticket  not suppoert super_user</td>
                   <td style="background-color:red; text-align:center;"><a href="<%=request.getContextPath()%>/Staza?id=<c:out value='${element.id}'/>&tip=buy&trak=Saudi Arabia&id_user=<% out.println(request.getParameter("id_user"));%>">Buy</a></td>
    		...
    		<c:if test="${element.super_user == 1}">
                  ...
                  <td style="background-color:red; text-align:center;"><a href="<%=request.getContextPath()%>/Staza?id=<c:out value='${element.id}'/>&tip=buy&trak=Saudi Arabia&id_user=<% out.println(request.getParameter("id_user"));%>&cena=<c:out value='${element.price-250}'/>">Buy</a></td>
